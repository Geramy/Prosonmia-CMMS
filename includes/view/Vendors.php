    ...
    $("#search").ready(function() {
        ...
        function SubmitSearch(sT, _id, _id1, _id2) {
            $.ajax({
              ...
              data: {RQ: "VENM", Method: "OrgSearch", id: _id, id1: _id1, id2: _id2},
...
<div class="formContainer">
    <ul class="nav nav-tabs">
        <li class="active"><a data-toggle="tab" href="#main">Vendor Search</a></li>
    ...
    <div class="tab-content">
        <div id="main" class="tab-pane fade in active">
            ...
            <div class="inputContainer">
                <form id="search" action="/Company/Companies/" method="post">
                    <div class="col-md-16">
                      <div class="row">
                        <div class="col-lg-5">
...
<table class="table">
    ...
    <tbody class="selectable">
        <?php
            ...
            $venList= $venApi->GetVendorList($id, $id1, $id2);
            foreach($venList as $value) {
                ?>
                <tr>
                    <td><?php echo $value["ven_name"]; ?></td>
                    <td><?php echo $value["ven_code"]; ?></td>
                    <td>0</td>
                    <td>0</td>
                    <td class="hidden"><?php echo $value["ven_pk"]; ?></td>
                </tr>
                <?php
            }
        ?>
