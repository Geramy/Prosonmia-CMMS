    ...
    $("#search").ready(function() {
        ...
        function SubmitSearch(sT, _id, _id1, _id2) {
            $.ajax({
              ...
              data: {RQ: "USM", Method: "OrgSearch", id: _id, id1: _id1, id2: _id2},
...
?>
        ...
        $("#search select[name='dep_pk']").on("change", function() {
            ...
            $('#search').attr('action', '/<?php echo $mod; ?>/<?php echo $act; ?>/<?php echo $id1; ?>/<?php echo $id2; ?>/'+$(this).val());
            $('#search').submit();
        });
    });
</script>
<div class="formContainer">
    <ul class="nav nav-tabs">
        <li class="active"><a data-toggle="tab" href="#main">Company Search</a></li>
    ...
    <div class="tab-content">
        <div id="main" class="tab-pane fade in active">
            ...
            <div class="inputContainer">
                <form id="search" action="/Users/ViewUsers/" method="post">
                    <div class="col-md-16">
                      <div class="row">
                        <div class="col-lg-5">
...
<table class="table">
    ...
    <tbody>
        <?php
            $id = $_GET["id"];
            $userAPI = new UserAPI($dbCon);
            $users = $userAPI->UserSearch($id == null ? "NULL" : $id, $id1 == null ? "NULL" : $id1, $id2 == null ? "NULL" : $id2, false);
            foreach($users as $value) {
                ?>
                <tr>
                    <td><?php echo $value["usr_username"]; ?></td>
                    <td><?php echo $value["usr_email"]; ?></td>
                    <td><?php echo $value["usr_portal_login"] != 1 ? "No" : "Yes"; ?></td>
                </tr>
                <?php
            }
        ?>
