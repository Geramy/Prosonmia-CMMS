...
<div class="formContainer">
    <ul class="nav nav-tabs">
        <li class="active"><a data-toggle="tab" href="#main">Work Order Search</a></li>
        ...
        <div class="row">
            ...
            if($i < $total_count)
            {
                ...
                <div class="col-md-3 circle-j">
                    ...
                    <dl id="<?php echo $equipList[$i]["eq_pk"]; ?>">
                        <dt class="text-center"><?php echo $equipList[$i]["eq_code"]; ?></dt>
                        <dt class="text-center"><?php echo $equipList[$i]["eq_item_type"]; ?></dt>
                        <dt class="text-center"><?php echo $equipList[$i]["eq_manufacturer"]; ?></dt>
                        <dt class="text-center"><?php echo $equipList[$i]["eq_model"]; ?></dt>
                    </dl>
                </div>
            <?php
            }
