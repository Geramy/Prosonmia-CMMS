    ...
    $("#search").ready(function() {
        ...
        function SubmitSearch(sT, _id, _id1, _id2) {
            $.ajax({
              ...
              data: {RQ: "INVM", Method: "OrgSearch", id: _id, id1: _id1, id2: _id2},
...
<div class="formContainer">
    <ul class="nav nav-tabs">
        <li class="active"><a data-toggle="tab" href="#main">Inventory Search</a></li>
	...
	<table class="table">
	    ...
	    <tbody class="selectable">
	        <?php
	            ...
	            $InvList = $InvHandler->Search($id, $id1, $id2);
	            foreach($InvList as $value) {
	                ?>
	                <tr>
	                    <td><?php echo $value["inv_code"]; ?></td>
	                    <td><?php echo $value["inv_model"]; ?></td>
	                    <td><?php echo $value["inv_manufacturer"]; ?></td>
	                    <td><?php echo $value["inv_serial_number"]; ?></td>
	                    <td class="hidden"><?php echo $value["inv_pk"]; ?></td>
	                </tr>
	                <?php
	            }
	        ?>
