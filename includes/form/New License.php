...
<div class="formContainer" id="new_license">
    <form action="/includes/itasm.networking.php" method="post">
        <ul class="nav nav-tabs">
            <li class="active"><a data-toggle="tab" href="#main">New License</a></li>
        </ul>
        <div class="tab-content">
            <div id="main" class="tab-pane fade in active">
                ...
                <div class="inputContainer">
                    ...
                    <div class="input-group input-group-lg">
                        <input class="form-control" type="text" name="eq_parent_code" placeholder="" required="false" />
                    </div>
                    <label class="required">License Key:</label>
                    <div class="input-group input-group-lg">
                        <input class="form-control" type="text" name="lic_key" placeholder="" required="true" />
                    </div>
                    
                    <input type="hidden" name="pur_itemType" value="1" />
                    <input type="hidden" name="RQ" value="COMP" />
                    <input type="hidden" name="Method" value="Create" />
                    <button class="submit" name="eq_sub">Create License</button>
                </div>
            </div>
        </div>
    </form>
