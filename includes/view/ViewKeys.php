    ...
    $("#search").ready(function() {
        ...
        function SubmitSearch(sT, _id, _id1, _id2) {
            $.ajax({
              ...
              data: {RQ: "LICM", Method: "OrgSearch", id: _id, id1: _id1, id2: _id2},
...
<div class="formContainer">
    <ul class="nav nav-tabs">
        <li class="active"><a data-toggle="tab" href="#main">License Search</a></li>
    ...
    <tbody class="selectable">
        ...
        if(array_key_exists ("id", $_GET)) {
            ...
            foreach($equipList as $value) {
                ?>
                <tr>
                    <td><?php echo $value["eq_code"]; ?></td>
                    <td><?php echo $value["eq_item_type"]; ?></td>
                    <td><?php echo $value["eq_manufacturer"]; ?></td>
                    <td><?php echo $value["eq_model"]; ?></td>
                    <td class="hidden"><?php echo $value["eq_pk"]; ?></td>
                </tr>
                <?php
            }
        }
