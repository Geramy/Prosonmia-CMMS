    ...
    $("#search").ready(function() {
        ...
        function SubmitSearch(sT, _id, _id1, _id2) {
            $.ajax({
              ...
              data: {RQ: "CONM", Method: "OrgSearch", id: _id, id1: _id1, id2: _id2},
...
<div class="formContainer">
    <ul class="nav nav-tabs">
        <li class="active"><a data-toggle="tab" href="#main">Contact Search</a></li>
...
if(array_key_exists ("id", $_GET)) {
    $contact = new ContactAPI($dbCon);
    $contactList = $contact->ContactSearch(array_key_exists("id", $_GET) ? $id : "NULL", array_key_exists("id1", $_GET) ? $id1 : "NULL", array_key_exists("id2", $_GET) ? $id2 : "NULL");
    ...
    while($row < $total_rows)
    {
        ...
        while($i < 3 && $count_item < $total_count) {
            ...
            <div class="col-md-3 circle-j">
                ...
                <dl id="<?php echo $contactList[$count_item]["con_pk"]; ?>">
                    <dt class="text-center"><?php echo $contactList[$count_item]["con_type"]; ?></dt>
                    <dt class="text-center"><?php echo $contactList[$count_item]["con_fname"]. " " .$contactList[$count_item]["con_lname"]; ?></dt>
                    <dt class="text-center"><?php echo $contactList[$count_item]["con_phone"]; ?></dt>
                    <dt class="text-center"><?php echo $contactList[$count_item]["con_email"]; ?></dt>
                </dl>
            </div>
            <?php
            $count_item++;
