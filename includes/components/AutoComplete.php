...
abstract class AutoComplete implements IHTMLComponent {
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                      <div class="panel-heading">
                          <div class="input-group input-group-sm edittable">
            ...
            <?php echo $KeyValue["container-id"]; ?>BOXObj = bootbox.dialog({
              ...
              buttons: {
                success: {
                  ...
                  callback: function() {
                      <?php if(array_key_exists("save_shorthand", $KeyValue)) echo $KeyValue["save_shorthand"]; ?>CreateOAC();
    ...
    {
        switch($subNumber) {
            case AutoComplete::$SubNumber_ListItemOne:
